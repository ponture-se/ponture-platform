...
export default function BusinessLoan(props) {
  ...
  const [pandeminChk, togglePandeminChk] = useState(true);
  const [pandeminInput, setPandeminInput] = useState("");
  const [pandeminInputIsValid, togglePanademinInputIsValid] = useState(true);
  useEffect(() => {
  ...
  const handlePhoneNumberChanged = useCallback(
    ...
    [setPhoneNumber, _setPhoneNumber, t]
  );
  ...
  function handleSubmitClicked() {
    if (!submitSpinner) {
      let isValid = true;
      if (pandeminInput.length === 0) {
        isValid = false;
        togglePanademinInputIsValid(false);
      }
            ...
            {tab === 1 && (
              <>
                <div className="bl__mainform">
                  ...
                  <div className="bl__input pandeminChk animated fadeIn">
                  ...
                  >
                    ...
                    <div className="bl__input__element">
                      <div className="element-group">
                        <div className="element-group__center">
                          <input
                            ...
                            value={pandeminInput}
                            onChange={(e) => {
                              setPandeminInput(e.target.value);
                              togglePanademinInputIsValid(
                      ...
                      {!pandeminInputIsValid && (
                        <span className="validation-messsage">
                          {t("PANADEMIN_IS_REQUIRED")}
                        </span>
                      )}
                    </div>
                  </div>
